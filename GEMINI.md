...
17. For every mathematical formula, the very next line must be a Markdown blockquote (starting with ">") that explains (1) what the formula does, (2) the meaning of each term, and (3) if the formula is hard to grasp, an analogy from everyday life that makes it intuitive.
